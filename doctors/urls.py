...
#    path('visit/<int:visit_id>/cancel/', views.cancel_visit_time, name='cancel_visit_time'),
    ...
    path('showtimesheet/<int:timesheet_id>/' , views.available_times_for_timesheet, name='show_timesheet'),

    path("near-doctor/", views.near_doctor, name="near_doctor"),

    path('add/<int:doctor_id>' , views.add_office,name= 'add_office'),

    path('timesheets/add/<int:doctor_id>/<int:office_id>/', views.add_timesheet, name='add_timesheet'),
